...
/**
 * PhetioGroup for creating EnergyChunkWanderControllers. This type adds support for dynamically created and destroyed, instrumented
 * PhET-iO elements.
 *
...
class EnergyChunkWanderControllerGroup extends PhetioGroup {
  ...
  constructor( energyChunkGroup, options ) {
    ...
    const defaultArguments = [ energyChunkGroup.archetype, energyChunkGroup.archetype ? energyChunkGroup.archetype.positionProperty : null, {} ];

    super( EnergyChunkWanderControllerGroup.createEnergyChunkWanderController,
      defaultArguments, options );
  }
