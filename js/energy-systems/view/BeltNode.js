...
define( function( require ) {
  ...
  function BeltNode( belt, modelViewTransform ) {
    ...
    var wheel1Center = modelViewTransform.modelToView( belt.wheel1Center );
    var wheel2Radius = modelViewTransform.modelToViewDeltaX( belt.wheel2Radius );
    var wheel2Center = modelViewTransform.modelToView( belt.wheel2Center );
    ...
    var wheel1ToOneEdge = wheel1CenterToWheelTwoCenter.getPerpendicularVector().getInstanceOfMagnitude( wheel1Radius );
    var wheel2ToOneEdge = wheel1CenterToWheelTwoCenter.getPerpendicularVector().getInstanceOfMagnitude( wheel2Radius );
